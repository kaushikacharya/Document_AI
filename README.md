...
DeepLearning.ai course: Document AI: From OCR to Agentic Doc Extraction
...
- [Course Website](https://www.deeplearning.ai/short-courses/document-ai-from-ocr-to-agentic-doc-extraction/)

## Course Contents

|#|Lesson|Description|
|-|-------------|-----------------|
|0|[Introduction](./notes/Lesson_0.md)|<ul><li>Course outline: Lessons & Assignments</li><li>Traditional OCR limits</li><li>Landind AI's Agentic Document Extraction capability</li></ul>|
